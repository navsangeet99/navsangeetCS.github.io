...
module.exports = () => {
  ...
  router.get("/:userId?", async (req, res, next) => { // it has an userId option and if userid is given it will return the particular user with that id an dif it is not given then it will give all the users in the database
  ...
  router.get("/impersonate/:userId", (req, res) => { // set session to given user and need it when the user put items in the basket
